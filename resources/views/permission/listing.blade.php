            ...
            <div class="row row-sm">
                <div class="col-lg-12">
                    <div class="card custom-card">
                        <div class="card-body">
                            <a href="{{ route('permission.create') }}" class="btn btn-primary" style="float:right">Add Permission</a>
                            <div>
                            ...
                            <div class="table-responsive">
                                    ...
                                    <tbody>
                                        @foreach($data['Permission'] as $sno => $item)
                                        <tr>
                                            <td>{{ ++$loop->index }}</td>
                                            <td>{{ $item->name }}</td>
                                            <td>
                                                <a href="{{ route('permission.edit',$item->id) }}" class="btn btn-primary btn-sm">Edit</a>
