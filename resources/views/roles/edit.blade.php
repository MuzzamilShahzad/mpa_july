                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('role.update', $data['Role']->id) }}" method="POST">
                                ...
                                <input name="id" class="form-control" type="hidden" value="{{ $data['Role']->id }}" id="role-id">


                                <div class="form-group">
                                    <label class="tx-semibold">Role Name</label>
                                    <input name="role" class="form-control" type="text" value="{{ $data['Role']->name }}" placeholder="Enter Role Name" id="role">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-controls-stacked">
                                        ...
                                        <label class="custom-control custom-checkbox mb-3">
                                            <input type="checkbox" name="permission[]" class="permission custom-control-input" value="{{ $item->id }}" {{ in_array($item->id, $data["role_permission"]) ? 'checked' : '' }} />
                        ...
                        <button class="btn ripple btn-primary" id="btn-update-role" type="submit">Submit</button>
